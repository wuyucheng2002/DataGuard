...
from my_TIPRDC.component import Feature_Extractor, Classifier, evaluate
...
def train_FE_CF(FE, CF, data, epochs=20, batch_size=256, lr=0.1):
    ...
    np.savez('./model/pre_train/FE.npz', w=weights_FE)
    np.savez('./model/pre_train/CF.npz', w=weights_CF)
