"""
本模块用于训练并保存nn_defense
"""
from my_AttriGuard.model import nn_model_defense, evaluate
from my_AttriGuard.input_data import Data
import tensorflow as tf
import numpy as np


def train_nn_defense(batch_size, learning_rate, epochs):
    """
    训练并保存nn_defense
    """
    data = Data()
    ...
    np.savez('./model/nn_model_defense.npz', w=weights)
